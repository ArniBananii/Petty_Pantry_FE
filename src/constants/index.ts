...
export const POST_UNQING_ENDPOINT = `${BASE_BACKEND_URL}`.concat(import.meta.env.VITE_ENDPOINT_POSTUNQING);
export const DELETE_UNQING_ENDPOINT = `${BASE_BACKEND_URL}`.concat(import.meta.env.VITE_ENDPOINT_DELETEUNQING);
