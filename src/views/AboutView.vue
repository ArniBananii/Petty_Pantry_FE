  ...
  <div class="about-view" style="height: 100vh; border: none">
    <div class="container">
      <ul class="nav nav-underline" style="top: 2px; z-index: 1000">
        ...
        <li class="nav-item">
          <a class="nav-link" style="color: white" href="/addingredient">Add Ingredients</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="#" style="color: coral" aria-current="page">About us</a>
        </li>
    ...
    <div class="container about-view text-center">
      ...
      <p style="color: white">Arno Heitmann and Sidar Dalli created this site in order to help People manage ingredients inside their pantry</p>
    </div>
  </div>
</template>
